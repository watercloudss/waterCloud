...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(DefaultWebSecurityManager securityManager) {
        ...
        shiroFilterFactoryBean.setLoginUrl("/sys-user/nologin");
        // 设置无权限时跳转的 url;
        shiroFilterFactoryBean.setUnauthorizedUrl("/sys-user/notRole");
        ...
        //用户，需要角色权限 “user”
        filterChainDefinitionMap.put("/sys-user/test1", "roles[user]");
        //管理员，需要角色权限 “admin”
        filterChainDefinitionMap.put("/sys-user/test2", "roles[admin]");
        //开放登陆接口
