...
public class CodeGenerator {
    private static final String modelName = "cloud-webmagic";
    private static final String packageName = "com.watercloud.webmagic";
    private static final String mapperXmlPath = "/src/main/java/com/watercloud/webmagic/mapper/";
